...
private extension NetworkService {
    ...
    private func refreshToken() {
        let service: Services = Services(service: self)
        
        service.performUserRefresh() { result in
            switch result {
            case .success(let response):
                print(response)
                print("REFRESH")
...
//    func showConnectError() {
//        let vc = ServerNotRespondingViewController()
...
//            showConnectError()
    ...
    private func showErrorMessage() {
        ...
        view.configureContent(title: nil, body: R.string.localizable.connectError(), iconImage: R.image.vpnErrorIcon(), iconText: nil, buttonImage: nil, buttonTitle: nil, buttonTapHandler: nil)
